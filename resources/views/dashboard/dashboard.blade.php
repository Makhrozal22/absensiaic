    ...
    <div class="section" id="user-section">
        ...
        <div id="user-detail">
            <div class="avatar">
                ...
                @else
                    <img src="assets/img/aic.png" alt="avatar" class="imaged w64 rounded">
                @endif
            </div>
            <div id="user-info">
            ...
            <div class="card-body text-center">
                <div class="list-menu">
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/editprofile" class="orange" style="font-size: 40px;">
                    ...
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/presensi" class="green" style="font-size: 40px;">
                            <ion-icon name="wallet-outline"></ion-icon>
                            </a>
                        </div>
                        <div class="menu-name">
                            <span class="text-center">Kafalah</span>
                        </div>
                    </div>
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                            <a href="/presensi" class="warning" style="font-size: 40px;">
                            <ion-icon name="medal-outline"></ion-icon>
                            </a>
                        </div>
                        <div class="menu-name">
                            <span class="text-center">Prestasi</span>
                        </div>
                    </div>
                    <div class="item-menu text-center">
                        <div class="menu-icon">
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="hand-left-outline" style="font-size: 1.6rem;"
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height:0.8rem">
                            ...
                            <ion-icon name="mail-unread-outline" style="font-size: 1.6rem;"
