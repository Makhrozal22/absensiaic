    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="kode_libur" class="form-control" value="{{ $harilibur->kode_libur }}"
        ...
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="tanggal_libur" class="form-control" placeholder="Tanggal Libur"
                    name="tanggal_libur" autocomplete="off" value="{{ $harilibur->tanggal_libur }}">
            </div>
        </div>
    </div>
    <div class="row mb-3">
        <div class="col-12">
            <div class="form-group">
                <select name="kode_cabang" id="kode_cabang" class="form-select">
                    ...
                    @foreach ($cabang as $d)
                        <option {{ $harilibur->kode_cabang == $d->kode_cabang ? 'selected' : '' }}
        ...
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" id="keterangan" autocomplete="off" class="form-control" placeholder="Keterangan"
                    name="keterangan" value="{{ $harilibur->keterangan }}">
            </div>
        </div>
    </div>
    <div class="row mt-2">
