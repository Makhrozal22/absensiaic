...
//Route Yang Bisa di AKses Oleh Administrator dan Admin Divisi dan finance
Route::group(['middleware' => ['role:administrator|admin divisi|finance,user']], function () {
...
Route::group(['middleware' => ['role:administrator|finance,user']], function () {
...
Route::get('/give-user-role', function () {
    try {
        ...
        $user->assignRole('administrator|finance');
        echo "Sukses";
    } catch (\Exception $e) {
        //throw $th;
        echo "Error";
